            ...
            <div className="container mx-auto mt-5 sm:mt-15 px-4 py-22 sm:py-16 lg:py-30">
                ...
                <div className="max-w-4xl mx-auto space-y-8 text-gray-700 text-sm sm:text-lg leading-relaxed">
                    ...
                    <section className="space-y-6">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-light text-shakespeare mb-6">
                            El Taller dels Sentits: 30 anys de trajectòria fent <em>ArtSalut</em>
                        </h2>
                        <p>
                            Amb el terme <em>Artsalut</em> el poeta Enric Casasses definia en una entrevista una de les seves 
                            ...
                            aquesta nova etapa del Taller dels Sentits centrada en l'<em>Artteràpia</em> i l'<em>Acompanyament 
                            Creatiu</em>.
                        </p>
                    </section>
                    ...
                    <section className="space-y-6 mt-12">
                        <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-shakespeare mb-6">
                            D'on venim….
                        </h3>
                        <p>
                            ...
                            escoles anomenat <em>"Aprendre a mirar un Quadre"</em>, així com també formacions al 
                            professorat.
                        </p>
                        <p>
                            Saber com acompanyar les persones, des del material sensible que es desplega, em 
                            porta a formar-me durant tots aquets anys en diversos postgraus i màsters d'<em>Artteràpia</em> i, 
                            ...
                            de dia <em>"Guardar la Vida"</em> per l'Ajuntament de Vilanova i la Geltrú i la Diputació de 
                            Barcelona.
                        </p>
                        <p>
                    ...
                    <section className="space-y-6 mt-12">
                        ...
                        <p>
                            El Taller del Sentits, d'ofereix els seus cursos grupals d'<em>Acompanyament Creatiu</em> a 
                            adolescents, joves i adults anomenats <em>L'Artperdins</em>, i per tal d'atendre amb rigor les 
                            ...
                            un Espai per fer <em>"Artsalut"</em>, tot allunyant brogits i presses i donant espai a l'escolta 
                            interna i al propi permís per sentir, expressar i reconnectar amb la nostra essència més 
                            creativa.
                        </p>
                        <p>
                            El Taller dels Sentits, és un projecte viu que, des dels llenguatges més subtils, es manté 
                            en una línia ferma d'actuació amb l'objectiu de recosir Art i Vida tot anant d'una a l'altra 
                            com un acte valent, expressió de cura del viure que avui se'ns fa imprescindible atendre.
                        </p>
                        <p>
                            El Taller dels Sentits és un espai respectuós i de permís que propicia l'escolta acurada 
                            de les persones a través de les eines de l'Art, expressant i re-creant tot aquest material 
                            sensible de què som fets i poder-lo transformar en experiència enriquidora i de cura del 
                            viure.
                        </p>
                    </section>
                </div>
